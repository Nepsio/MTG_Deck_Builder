...
function Navbar() {
    return  (   
        <nav class="bg-white dark:bg-gray-900  w-full z-20 top-0 left-0 border-b border-gray-500 dark:border-gray-600 b-4">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between  p-2">
                <a href="" class="flex items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MTG Deck Builder
                </span>
                </a>
